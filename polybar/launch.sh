...
CONFIG_FILE="$HOME/.local/share/dwm-pathvoid/polybar/themes/$THEME/config.ini"
LAPTOP_CONFIG_FILE="$HOME/.local/share/dwm-pathvoid/polybar/themes/$THEME/laptop-config.ini"
